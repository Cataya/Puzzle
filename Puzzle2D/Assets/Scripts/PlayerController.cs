...
public class PlayerController : MonoBehaviour {
    ...
    void Update() {
        ...
        if (IsThereObstacleBelow1() && g1 != null) {
        ...
        if (!IsThereObstacleBelow1()/* && IsThereObstacleLeft() && IsThereObstacleRigh()*/) {
            spawnY1 = spawnY1 - velocity * Time.deltaTime;                    //Ohjataan spriten liikettä y-akselilla
        }
